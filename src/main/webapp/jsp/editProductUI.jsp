...
<div id="main" style="font-size: 12px;">
		...
		<div class="container-fluid">
			...
			<form id="saveuser" class="form-horizontal" role="form" action="<%=basePath%>product/editProduct" method="post" onsubmit="return check()">
		...
		<div class="form-group">
			<label for="loginname" class="col-sm-2 control-label">得分</label>
			<div class="col-sm-3">
				<input type="text" class="form-control" name="myscore2"
					placeholder="" value="${product.myscore2 }">
		...
		<div class="form-group">
			<label for="loginname" class="col-sm-2 control-label">价格</label>
			<div class="col-sm-3">
				<input type="text" class="form-control" name="productPrice"
					placeholder="" value="${product.productPrice }">
